...
Веб-версия доступна по ссылке: [https://play.unity.com/en/games/3dd93d33-0b83-42cb-877f-70831a1f4746/runner-hse](https://play.unity.com/en/games/3dd93d33-0b83-42cb-877f-70831a1f4746/runner-hse)
...
# Новое для HomeAssignment_2
- Добавлено главное меню и меню паузы
- Добавлен трекинг лучшего результата
- Добавлены щиты
- "Препятствия" теперь влияют на щиты и результат, а так же могут удаляться после столкновения (через это реализованы бонусы). Кроме того, препятствия могут удаляться без эффектов, если у игрока есть указанное количество щитов (так работают стены)
- Добавлены подбираемые бонусы - монеты и щиты (в виде +)
- Монета увеличивают результат, щит пробивают одну стену
- Результат складывается из пройденного расстояния, собранных монет и уменьшается от столкновений с шипами
